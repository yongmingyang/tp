...
public class CommandTestUtil {
    ...
    public static final EditCommand.EditQuestionSetDescriptor DESC_A;
    public static final EditCommand.EditQuestionSetDescriptor DESC_B;

    static {
        DESC_A = new EditQuestionSetDescriptorBuilder().withQuestion(VALID_QUESTION_A)
                .withAnswer(VALID_ANSWER_A)
                .withTags(VALID_TAG_TAG1).build();
        DESC_B = new EditQuestionSetDescriptorBuilder().withQuestion(VALID_QUESTION_B)
