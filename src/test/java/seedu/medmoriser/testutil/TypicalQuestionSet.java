...
public class TypicalQuestionSet {
    ...
    public static final QuestionSet ALICE = new QuestionSetBuilder().withQuestion("Alice Pauline")
            .withAnswer("123, Jurong West Ave 6, #08-111").withEmail("alice@example.com")
            .withPhone("94351253")
            .withTags("friends").build();
    public static final QuestionSet BENSON = new QuestionSetBuilder().withQuestion("Benson Meier")
            .withAnswer("311, Clementi Ave 2, #02-25")
            .withEmail("johnd@example.com").withPhone("98765432")
            .withTags("owesMoney", "friends").build();
    public static final QuestionSet CARL = new QuestionSetBuilder().withQuestion("Carl Kurz").withPhone("95352563")
            .withEmail("heinz@example.com").withAnswer("wall street").build();
    public static final QuestionSet DANIEL = new QuestionSetBuilder().withQuestion("Daniel Meier").withPhone("87652533")
            .withEmail("cornelia@example.com").withAnswer("10th street").withTags("friends").build();
    public static final QuestionSet ELLE = new QuestionSetBuilder().withQuestion("Elle Meyer").withPhone("9482224")
            .withEmail("werner@example.com").withAnswer("michegan ave").build();
    public static final QuestionSet FIONA = new QuestionSetBuilder().withQuestion("Fiona Kunz").withPhone("9482427")
            .withEmail("lydia@example.com").withAnswer("little tokyo").build();
    public static final QuestionSet GEORGE = new QuestionSetBuilder().withQuestion("George Best").withPhone("9482442")
            .withEmail("anna@example.com").withAnswer("4th street").build();

    // Manually added
    public static final QuestionSet HOON = new QuestionSetBuilder().withQuestion("Hoon Meier").withPhone("8482424")
            .withEmail("stefan@example.com").withAnswer("little india").build();
    public static final QuestionSet IDA = new QuestionSetBuilder().withQuestion("Ida Mueller").withPhone("8482131")
    ...
    public static final QuestionSet AMY = new QuestionSetBuilder().withQuestion(VALID_QUESTION_AMY)
            .withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withAnswer(VALID_ANSWER_AMY)
            .withTags(VALID_TAG_FRIEND).build();
    public static final QuestionSet BOB = new QuestionSetBuilder().withQuestion(VALID_QUESTION_BOB)
